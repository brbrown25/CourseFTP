...
This has been modified from cod found at 
    ...
    if (options.username and options.server and options.remote_dir) or \
        ...
        if os.path.exists(default_config_file):
            ...
            try:
                ...
                print 'password = <Password for access to given server>'
        ...
        if monitor:
            try:
            	monitor_and_ftp(server,username,password,local_dir, remote_dir, encrypt, walk)
            except KeyboardInterrupt:
                print 'Exiting...'
        else:  
            try:
            	upload_all(server, username, password, local_dir, remote_dir, [], encrypt, walk)
            except KeyboardInterrupt:
                print 'Exiting...'            
